  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 space-y-5 text-lg text-ink-700">
        <p>
          SignBridge is a free, open-source web app that teaches sign language
          fingerspelling and interprets it live — sign in front of your camera and hear your
          words spoken aloud. It supports American Sign Language (ASL) and Pakistan Sign
          Language (PSL).
        </p>
        <p>
        ...
        <p>
          <strong className="text-ink-900">Honest scope.</strong> SignBridge recognizes
          fingerspelling (A–Z) and is growing toward a fixed vocabulary of common signs. It is a
          learning tool and a fingerspelling interpreter — not a full conversational sign language
